...
SlotSelect::SlotSelect(QWidget *parent,FF7Save *data):QDialog(parent)
{
    ...
    for(int i=0;i<15;i++)
    {
        ...
        else if(data->isFF7(i))
        {
            ...
            image.setPixel(0, 0, QColor(data->slot[i].colors[0][0],data->slot[i].colors[0][1],data->slot[i].colors[0][2]));
            image.setPixel(0, 1, QColor(data->slot[i].colors[2][0],data->slot[i].colors[2][1],data->slot[i].colors[2][2]));
            image.setPixel(1, 0, QColor(data->slot[i].colors[1][0],data->slot[i].colors[1][1],data->slot[i].colors[1][2]));
            image.setPixel(1, 1, QColor(data->slot[i].colors[3][0],data->slot[i].colors[3][1],data->slot[i].colors[3][2]));
