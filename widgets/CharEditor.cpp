...
void CharEditor::init_display()
{
	...
	lbl_avatar->setFixedSize(86*scale,98*scale);
	...
	bar_tnl->setFixedHeight(10*scale);
	bar_tnl->setFixedWidth(61*scale);
	...
	slider_limit->setMaximumHeight(20*scale);
	...
	lcd_0x34->setFixedSize(32*scale,20*scale);
	lcd_0x34->setHexMode();
	...
	lcd_0x35->setFixedSize(32*scale,20*scale);
	lcd_0x35->setHexMode();
	...
	lcd_0x36->setFixedSize(32*scale,20*scale);
	lcd_0x36->setHexMode();
	...
	lcd_0x37->setFixedSize(32*scale,20*scale);
	lcd_0x37->setHexMode();
	...
	materia_edit->setStarsSize(32*scale);
	...
	weapon_slot_1->setFixedSize(32*scale,32*scale);
	weapon_slot_1->setIconSize(QSize(32*scale,32*scale));
	...
	weapon_frm_1->setFixedSize(32*scale,32*scale);
	...
	weapon_m_link_1->setFixedSize(12*scale,16*scale);

	weapon_slot_2 = new QPushButton();
	weapon_slot_2->setFixedSize(32*scale,32*scale);
	weapon_slot_2->setIconSize(QSize(32*scale,32*scale));
	...
	weapon_frm_2->setFixedSize(32*scale,32*scale);
	...
	weapon_slot_3->setFixedSize(32*scale,32*scale);
	weapon_slot_3->setFlat(true);
	weapon_slot_3->setAutoFillBackground(true);
	weapon_slot_3->setIconSize(QSize(32*scale,32*scale));
	...
	weapon_frm_3->setFixedSize(32*scale,32*scale);
	...
	weapon_m_link_2->setFixedSize(12*scale,16*scale);

	weapon_slot_4 = new QPushButton();
	weapon_slot_4->setFixedSize(32*scale,32*scale);
	weapon_slot_1->setStyleSheet(Items.styleMateriaSlotNoGrowth());
	weapon_slot_4->setFlat(true);
	weapon_slot_4->setAutoFillBackground(true);
	weapon_slot_4->setIconSize(QSize(32*scale,32*scale));
	...
	weapon_frm_4->setFixedSize(32*scale,32*scale);
	...
	weapon_slot_5->setFixedSize(32*scale,32*scale);
	weapon_slot_5->setFlat(true);
	weapon_slot_5->setAutoFillBackground(true);
	weapon_slot_5->setIconSize(QSize(32*scale,32*scale));
	...
	weapon_frm_5->setFixedSize(32*scale,32*scale);
	...
	weapon_m_link_3->setFixedSize(12*scale,16*scale);

	weapon_slot_6 = new QPushButton();
	weapon_slot_6->setFixedSize(32*scale,32*scale);
	weapon_slot_6->setFlat(true);
	weapon_slot_6->setAutoFillBackground(true);
	weapon_slot_6->setIconSize(QSize(32*scale,32*scale));
	...
	weapon_frm_6->setFixedSize(32*scale,32*scale);
	...
	weapon_slot_7->setFixedSize(32*scale,32*scale);
	weapon_slot_7->setFlat(true);
	weapon_slot_7->setAutoFillBackground(true);
	weapon_slot_7->setIconSize(QSize(32*scale,32*scale));
	...
	weapon_frm_7->setFixedSize(32*scale,32*scale);
	...
	weapon_m_link_4->setFixedSize(12*scale,16*scale);

	weapon_slot_8 = new QPushButton();
	weapon_slot_8->setFixedSize(32*scale,32*scale);
	weapon_slot_8->setFlat(true);
	weapon_slot_8->setAutoFillBackground(true);
	weapon_slot_8->setIconSize(QSize(32*scale,32*scale));
	...
	weapon_frm_8->setFixedSize(32*scale,32*scale);
	...
	armor_slot_1->setFixedSize(32*scale,32*scale);
	armor_slot_1->setIconSize(QSize(32*scale,32*scale));
	...
	armor_frm_1->setFixedSize(32*scale,32*scale);
	...
	armor_m_link_1->setFixedSize(12*scale,16*scale);

	armor_slot_2 = new QPushButton();
	armor_slot_2->setFixedSize(32*scale,32*scale);
	armor_slot_2->setIconSize(QSize(32*scale,32*scale));
	...
	armor_frm_2->setFixedSize(32*scale,32*scale);
	...
	armor_slot_3->setFixedSize(32*scale,32*scale);
	armor_slot_3->setFlat(true);
	armor_slot_3->setAutoFillBackground(true);
	armor_slot_3->setIconSize(QSize(32*scale,32*scale));
	...
	armor_frm_3->setFixedSize(32*scale,32*scale);
	...
	armor_m_link_2->setFixedSize(12*scale,16*scale);
	armor_m_link_2->setScaledContents(1);

	armor_slot_4 = new QPushButton();
	armor_slot_4->setFixedSize(32*scale,32*scale);
	armor_slot_1->setStyleSheet(Items.styleMateriaSlotNoGrowth());
	armor_slot_4->setFlat(true);
	armor_slot_4->setAutoFillBackground(true);
	armor_slot_4->setIconSize(QSize(32*scale,32*scale));
	...
	armor_frm_4->setFixedSize(32*scale,32*scale);
	...
	armor_slot_5->setFixedSize(32*scale,32*scale);
	armor_slot_5->setFlat(true);
	armor_slot_5->setAutoFillBackground(true);
	armor_slot_5->setIconSize(QSize(32*scale,32*scale));
	...
	armor_frm_5->setFixedSize(32*scale,32*scale);
	...
	armor_m_link_3->setFixedSize(12*scale,16*scale);
	armor_m_link_3->setScaledContents(1);

	armor_slot_6 = new QPushButton();
	armor_slot_6->setFixedSize(32*scale,32*scale);
	armor_slot_6->setFlat(true);
	armor_slot_6->setAutoFillBackground(true);
	armor_slot_6->setIconSize(QSize(32*scale,32*scale));
	...
	armor_frm_6->setFixedSize(32*scale,32*scale);
	...
	armor_slot_7->setFixedSize(32*scale,32*scale);
	armor_slot_7->setFlat(true);
	armor_slot_7->setAutoFillBackground(true);
	armor_slot_7->setIconSize(QSize(32*scale,32*scale));
	...
	armor_frm_7->setFixedSize(32*scale,32*scale);
	...
	armor_m_link_4->setFixedSize(12*scale,16*scale);
	armor_m_link_4->setScaledContents(1);

	armor_slot_8 = new QPushButton();
	armor_slot_8->setFixedSize(32*scale,32*scale);
	armor_slot_8->setFlat(true);
	armor_slot_8->setAutoFillBackground(true);
	armor_slot_8->setIconSize(QSize(32*scale,32*scale));
	...
	armor_frm_8->setFixedSize(32*scale,32*scale);
...
void CharEditor::update_materia_slots()
{
	...
	armor_m_link_4->setStyleSheet(QString("background-color:rgba(0,0,0,0);"));
	 ...
	 if(data.materias[0].id!=FF7Materia::EmptyId){weapon_slot_1->setIcon(QIcon(Materias.pixmap(data.materias[0].id).scaled(24*scale,24*scale,Qt::KeepAspectRatio,Qt::SmoothTransformation)));}else{weapon_slot_1->setIcon(QIcon(QString("")));}
	 ...
	 if(data.materias[1].id!=FF7Materia::EmptyId){weapon_slot_2->setIcon(QIcon(Materias.pixmap(data.materias[1].id).scaled(24*scale,24*scale,Qt::KeepAspectRatio,Qt::SmoothTransformation)));}else{weapon_slot_2->setIcon(QIcon(QString("")));}
	 ...
	 if(data.materias[2].id!=FF7Materia::EmptyId){weapon_slot_3->setIcon(QIcon(Materias.pixmap(data.materias[2].id).scaled(24*scale,24*scale,Qt::KeepAspectRatio,Qt::SmoothTransformation)));}else{weapon_slot_3->setIcon(QIcon(QString("")));}
	 ...
	 if(data.materias[3].id!=FF7Materia::EmptyId){weapon_slot_4->setIcon(QIcon(Materias.pixmap(data.materias[3].id).scaled(24*scale,24*scale,Qt::KeepAspectRatio,Qt::SmoothTransformation)));}else{weapon_slot_4->setIcon(QIcon(QString("")));}
	 ...
	 if(data.materias[4].id!=FF7Materia::EmptyId){weapon_slot_5->setIcon(QIcon(Materias.pixmap(data.materias[4].id).scaled(24*scale,24*scale,Qt::KeepAspectRatio,Qt::SmoothTransformation)));}else{weapon_slot_5->setIcon(QIcon(QString("")));}
	 ...
	 if(data.materias[5].id!=FF7Materia::EmptyId){weapon_slot_6->setIcon(QIcon(Materias.pixmap(data.materias[5].id).scaled(24*scale,24*scale,Qt::KeepAspectRatio,Qt::SmoothTransformation)));}else{weapon_slot_6->setIcon(QIcon(QString("")));}
	 ...
	 if(data.materias[6].id!=FF7Materia::EmptyId){weapon_slot_7->setIcon(QIcon(Materias.pixmap(data.materias[6].id).scaled(24*scale,24*scale,Qt::KeepAspectRatio,Qt::SmoothTransformation)));}else{weapon_slot_7->setIcon(QIcon(QString("")));}
	 ...
	 if(data.materias[7].id!=FF7Materia::EmptyId){weapon_slot_8->setIcon(QIcon(Materias.pixmap(data.materias[7].id).scaled(24*scale,24*scale,Qt::KeepAspectRatio,Qt::SmoothTransformation)));}else{weapon_slot_8->setIcon(QIcon(QString("")));}
	 ...
	 if(data.materias[8].id!=FF7Materia::EmptyId){armor_slot_1->setIcon(QIcon(Materias.pixmap(data.materias[8].id).scaled(24*scale,24*scale,Qt::KeepAspectRatio,Qt::SmoothTransformation)));}else{armor_slot_1->setIcon(QIcon(QString("")));}
	 ...
	 if(data.materias[9].id!=FF7Materia::EmptyId){armor_slot_2->setIcon(QIcon(Materias.pixmap(data.materias[9].id).scaled(24*scale,24*scale,Qt::KeepAspectRatio,Qt::SmoothTransformation)));}else{armor_slot_2->setIcon(QIcon(QString("")));}
	 ...
	 if(data.materias[10].id!=FF7Materia::EmptyId){armor_slot_3->setIcon(QIcon(Materias.pixmap(data.materias[10].id).scaled(24*scale,24*scale,Qt::KeepAspectRatio,Qt::SmoothTransformation)));}else{armor_slot_3->setIcon(QIcon(QString("")));}
	 ...
	 if(data.materias[11].id!=FF7Materia::EmptyId){armor_slot_4->setIcon(QIcon(Materias.pixmap(data.materias[11].id).scaled(24*scale,24*scale,Qt::KeepAspectRatio,Qt::SmoothTransformation)));}else{armor_slot_4->setIcon(QIcon(QString("")));}
	 ...
	 if(data.materias[12].id!=FF7Materia::EmptyId){armor_slot_5->setIcon(QIcon(Materias.pixmap(data.materias[12].id).scaled(24*scale,24*scale,Qt::KeepAspectRatio,Qt::SmoothTransformation)));}else{armor_slot_5->setIcon(QIcon(QString("")));}
	 ...
	 if(data.materias[13].id!=FF7Materia::EmptyId){armor_slot_6->setIcon(QIcon(Materias.pixmap(data.materias[13].id).scaled(24*scale,24*scale,Qt::KeepAspectRatio,Qt::SmoothTransformation)));}else{armor_slot_6->setIcon(QIcon(QString("")));}
	 ...
	 if(data.materias[14].id!=FF7Materia::EmptyId){armor_slot_7->setIcon(QIcon(Materias.pixmap(data.materias[14].id).scaled(24*scale,24*scale,Qt::KeepAspectRatio,Qt::SmoothTransformation)));}else{armor_slot_7->setIcon(QIcon(QString("")));}
	 ...
	 if(data.materias[15].id!=FF7Materia::EmptyId){armor_slot_8->setIcon(QIcon(Materias.pixmap(data.materias[15].id).scaled(24*scale,24*scale,Qt::KeepAspectRatio,Qt::SmoothTransformation)));}else{armor_slot_8->setIcon(QIcon(QString("")));}
