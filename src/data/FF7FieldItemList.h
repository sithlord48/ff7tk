...
public:
     ...
     */
    static int size() { return get()->d->_fieldItemList.size(); }
...
private:
    ...
    FF7FieldItemList *operator = (FF7FieldItemList &other) = delete;
    FF7FieldItemList(const FF7FieldItemList &other) = delete;
    explicit FF7FieldItemList(QObject *parent = nullptr);
    ~FF7FieldItemList();
    struct FF7FieldItemListPrivate;
    FF7FieldItemListPrivate *d;
    struct FF7FieldItemListPrivate {
