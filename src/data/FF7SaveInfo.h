...
private:
    ...
    struct FF7SaveInfoPrivate {
        ...
        /*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~RZIP SAVE FORMAT~~~~~~~~~~~~~~~*/
        inline static const int RZIP_FILE_HEADER_SIZE = 0x0008;
        //7th char is the verison number
        inline static const QByteArray RZIP_FILE_ID = "\x23\x52\x5A\x49\x50\x76\x01\0x23";
        inline static const QString RZIP_FILE_DESCRIPTION = QT_TR_NOOP("Retroarch Compressed Savedata");
        inline static const QRegularExpression RZIP_VALID_NAME_REGEX = QRegularExpression(QStringLiteral("\\S+.srm"), QRegularExpression::CaseInsensitiveOption);
        inline static const QStringList RZIP_VALID_EXTENSIONS { QStringLiteral("*.srm") };
        /*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~DEFAULT SAVE DATA~~~~~~~~~~~~~~~~*/
