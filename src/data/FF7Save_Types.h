...
struct FF7TKDATA_EXPORT FF7SLOT {
    ...
    quint8 z_34[1];                 /**< [0x0E3B] UNKNOWN DATA*/
    quint8 battleArenaSpecialWins;  /**< [0x0E3C] Battle Arena Number of Wins in the "Special Battle"*/
    quint8 z_35[1];                 /**< [0x0E3D] UNKNOWN DATA*/
    quint8 stablechocorating[6];    /**< [0x0E3E] Choco Billy's Rating for chocobo in stable 1-6 (same ranks as penned)*/
    quint8 z_36[24];                /**< [0x0E44] UNKNOWN DATA*/
    ...
    quint8 z_46[236];               /**< [0x0F98] UNKNOWN DATA*/
    ...
    quint8 z_47[48];                /**< [0x10A8] UNKNOWN DATA*/
    ...
    quint8 z_48[8];                 /**< [0x10ED] UNKNOWN DATA*/
});
